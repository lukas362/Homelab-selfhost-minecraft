# Selfhost-Minecraft (homelab project)
This is a overview on how I selfhosted my own minecraft server on my own ubuntu server safely and manage to make it joinable to others. I used [`itzg/minecraft-server`](https://github.com/itzg/docker-minecraft-server) image and made a tunnel via [playit.gg](https://playit.gg) so that anyone could connect without the need for port fowarding.
